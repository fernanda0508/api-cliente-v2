...
class AlunosViewSet(viewsets.ModelViewSet):
    ...
    # passo 3:  Dependendo da versão da API que recebermos lá no nosso parâmetro,
    #  nós queremos exibir ou a versão 1, que é sem o celular, ou a versão 2, com o celular.
